    ...
    return (
        <div className="w-full h-auto bg-neutral-800 py-12">
            <RootLayout className="space-y-10">
                <motion.div
                    className="w-full grid grid-cols-1 md:grid-cols-5 gap-8"
                    initial="hidden"
                    animate="visible"
                    exit="hidden"
                    variants={variants}
                ...
                >
                    {/* Left Footer */}
                    <div className="md:col-span-2 space-y-6 md:pr-10 pr-0">
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-neutral-300 font-normal">
                                Bus is one of the most important and safest transportation systems. We make sure you enjoy the ride.
                            </p>
                        </div>

                        {/* Social media links */}
                        <div className="w-full flex items-center gap-x-5 flex-wrap gap-y-4">
                ...
                <div className="w-full flex flex-col md:flex-row md:items-center justify-between text-center md:text-left space-y-4 md:space-y-0">
