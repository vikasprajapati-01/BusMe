        ...
        <motion.div className="w-full rounded-xl p-5 border-2 border-neutral-300 space-y-10"
            ...
            <div className="space-y-3.5 w-full">
                ...
                <div className="space-y-0">
                    ...
                    {/* From */}
                    <div className="w-full flex items-center justify-between gap-x-3">
                        <h1 className="text-base md:text-xl text-neutral-600 font-semibold">
                            { from }
                        </h1>

                        {/* Travel Time */}
                        <div className="flex-1 border-dashed border border-neutral-400 relative">
                            <p className="absolute w-fit px-3 h-6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-50 rounded-full flex items-center justify-center text-xs md:text-sm text-neutral-500 font-normal border-dashed border border-neutral-500">
                                { travelTime }
                            </p>
                        </div>
            ...
            <div className="w-full flex items-center justify-between">
                {/* Price */}
                <h1 className="text-base md:text-xl text-neutral-700 font-semibold">
                    Rs. { price }
                </h1>
